...
//////////////////////////////////////////////////////////////////////////
// APokemonGameCharacter

APokemonGameCharacter::APokemonGameCharacter()
{
...
void APokemonGameCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APokemonGameCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &APokemonGameCharacter::Look);
	}
	else
	{
...
void APokemonGameCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APokemonGameCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
